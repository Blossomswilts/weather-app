...
//_________________________________Local-Call_____________________________________________________
getLocal()
...
//_________________________________5-Day-Forecast________________________________________________
                ...
                fetch(apiURL3).then(function (response) {
                    if (response.ok) {
                        response.json().then(function (data) {
                            ...
                            day1TempEl.textContent = "Temp: " + day1TempF.toFixed(0) + "°F";
                            day2TempEl.textContent = "Temp: " + day2TempF.toFixed(0) + "°F";
                            day3TempEl.textContent = "Temp: " + day3TempF.toFixed(0) + "°F";
                            day4TempEl.textContent = "Temp: " + day4TempF.toFixed(0) + "°F";
                            day5TempEl.textContent = "Temp: " + day5TempF.toFixed(0) + "°F";
                            ...
                            day2IconEl.setAttribute("src", "http://openweathermap.org/img/w/" + day2Icon + ".png");
                            let day3Icon = data.list[2].weather[0].icon;
                            const day3IconEl = document.querySelector(".icon-day3");
                            day3IconEl.setAttribute("src", "http://openweathermap.org/img/w/" + day3Icon + ".png");
                            let day4Icon = data.list[3].weather[0].icon;
                            const day4IconEl = document.querySelector(".icon-day4");
                            day4IconEl.setAttribute("src", "http://openweathermap.org/img/w/" + day4Icon + ".png");
                            let day5Icon = data.list[4].weather[0].icon;
                            const day5IconEl = document.querySelector(".icon-day5");
                            day5IconEl.setAttribute("src", "http://openweathermap.org/img/w/" + day5Icon + ".png");
 ...
 //____________________________________local-storage___________________________________________________________
                                ...
                                cityName.push(inputValue.value);
                        });
                    }
                });
            });
